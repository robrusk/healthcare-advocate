      ...
      {bill.biller_error_detected && (
        <div style={{
          ...
          <div style={{ fontSize: 13, fontWeight: 700, color: '#ff6060', marginBottom: 8, fontFamily: 'Georgia, serif' }}>
            🚨 BILLING ERROR - THIS MAY NOT BE YOUR RESPONSIBILITY
          </div>
          ...
          <p style={{ fontSize: 12, color: 'rgba(232,244,240,0.5)', margin: 0, fontFamily: 'monospace' }}>
            If the biller submitted to the wrong insurance company or missed a filing deadline,
            you are not legally required to pay for their mistake. The dispute letter below addresses this.
          </p>
        </div>
      )}
